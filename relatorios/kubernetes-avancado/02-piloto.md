# Kubernetes Avançado — Guia Prático (Fase 2) · Edição Piloto
...
Cada etapa segue sempre a mesma trilha: **o problema** (um cenário real que dói) → **conceito** → **exemplo comentado** → **comandos** → **mão na massa** (o menor exercício que prova que você entendeu) → **anota aí** (a ideia que você leva no bolso). A ordem das etapas é proposital: cada uma só usa o que a anterior já ensinou. Não pule. É igual a montar o fim de semana: treino livre antes da classificação, classificação antes da corrida.
